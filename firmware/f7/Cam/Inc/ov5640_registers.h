...
#define FRAME_CTRL01 \
  0x4201  // Control Passed Frame Number When both ON and OFF number set to
          // 0x00,frame control is in bypass mode Bit[7:4]: Not used Bit[3:0]:
          // Frame ON number
#define FRAME_CTRL02 \
  0x4202  // Control Masked Frame Number When both ON and OFF number set to
          // 0x00,frame control is in bypass mode Bit[7:4]: Not used BIT[3:0]:
          // Frame OFF number
...
#define OV5640_DRAW_WINDOW_HBW_CTRL_HIGH \
  0x5030U /* HBW: Horizontal Boundary Width */
#define OV5640_DRAW_WINDOW_HBW_CTRL_LOW 0x5031U
#define OV5640_DRAW_WINDOW_VBW_CTRL_HIGH \
  0x5032U /* VBW: Vertical Boundary Width */
...
#define OV5640_AWB_CTRL06 \
  0x5186U /* Advanced AWB control registers: 0x5186 ~ 0x5190 */
