...
//=============================================STM32 REGs==========================================================
 ...
 {OV5640_SCCB_SYSTEM_CTRL1, 0x11},
    ...
    {OV5640_FORMAT_MUX_CTRL, 0x01},
	//=======================================
    {OV5640_JPG_MODE_SELECT, 0x03},// set to 2 --> set to 3
    {OV5640_JPEG_CTRL07, 0x04},
    {0x440e, 0x00},
    {0x460b, 0x35},
    {0x460c, 0x23},
...
const uint16_t format_jpeg[][2] = {
		...
		// {JPG_MODE_SELECT, 0x03}, // JPEG mode 2
...
//	 input clock 24Mhz, PCLK 42Mhz
		...
		{OV5640_LIGHTMETER1_TH_LOW, 0x07}, // lightmeter 1 threshold[7:0]
		{OV5640_TIMING_TC_REG20, 0x46}, // flip
		{OV5640_TIMING_TC_REG21, 0x00}, // mirror
		{OV5640_TIMING_X_INC, 0x31}, // timing X inc
		{OV5640_TIMING_Y_INC, 0x31}, // timing Y inc
		{X_ADDR_ST_H, 0x00}, // HS
		{0x3801, 0x00}, // HS
		{0x3802, 0x00}, // VS
		{0x3803, 0x00}, // VS
